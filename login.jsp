...
<body onload="onLoad();">
	...
	<div class="LoginScreen">
		<div class="${smallScreen?'center-small':'center'}">
			...
			<div id="ZLoginAppName" style="display:block;"><div class="desc1" style="color:#1e282e"> <h4 style="color:#005a95 ;font-size:10px">Service Support Messagerie CNTE</h4> <p style="font-size:10px">Pour nous contacter :</p> <p style="font-size:10px"> <a href="mailto:helpmail.edunet.tn" style="cursor:pointer;" >Email : helpmail@edunet.tn</a> </p> </div>
			<div class="desc2" style="font-size:10px;color:#1e282e;line-height:1.5;max-width:280px"> Pour vous aider à accéder à votre compte de messagerie Edunet veuillez consulter <a href="http://www.cnte.tn/images/pdf/service-internet-messagerie-guide.pdf" style="cursor:pointer;">le guide utilisateur</a> ou visiter le centre d'aide de messagerie <a href="http://www.edutic.edunet.tn/helpmail/" style="cursor:pointer"> Edutic Edunet </a></div>
		</div>
			</div>
